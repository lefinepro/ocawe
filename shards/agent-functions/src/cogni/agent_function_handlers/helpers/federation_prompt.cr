...
TEXT
    ...
    private def output_path_from_context(ctx : Cogni::Workflow::NodeContext) : String
    ...
    private def context_string_param(ctx : Cogni::Workflow::NodeContext, key : String) : String
