module Ocawe
  module AgentFunctionHandlers
    ...
    private def provider_fallback_credentials_path(provider : String) : String
      "#{home_dir}/.config/ocawe/providers/#{provider}/credentials.json"
    end

    private def provider_fallback_config_path(provider : String) : String
      "#{home_dir}/.config/ocawe/providers/#{provider}/config.json"
    end

    private def resolve_provider_credentials_path(ctx : Ocawe::Workflow::NodeContext, provider : String) : String
    ...
    private def resolve_provider_config_path(ctx : Ocawe::Workflow::NodeContext, provider : String) : String
    ...
    private def provider_env(ctx : Ocawe::Workflow::NodeContext, provider : String) : Hash(String, String)
