    ...
    class App
      ...
      private def mount_agent_endpoints
        ...
        post "/v1/agents/:agentId/generate" do |env|
          ...
          agent_result = nil.as(Ocawe::Workflow::AgentResult?)
          begin
            ...
            agent_result = Ocawe::Workflow::AgentResult.new(
      ...
      private def extract_chat_messages(body : Ocawe::Workflow::AnyHash) : Array(NamedTuple(role: String, content: String))
      ...
      private def chat_prompt_from_messages(messages : Array(NamedTuple(role: String, content: String)), body : Ocawe::Workflow::AnyHash) : String
      ...
      private def chat_system_message(messages : Array(NamedTuple(role: String, content: String)), body : Ocawe::Workflow::AnyHash) : String?
