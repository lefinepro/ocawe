module ACD
  module HTTP
    class App
      ...
      private def extract_chat_messages(body : CogniCore::Workflow::AnyHash) : Array(NamedTuple(role: String, content: String))
      ...
      private def chat_prompt_from_messages(messages : Array(NamedTuple(role: String, content: String)), body : CogniCore::Workflow::AnyHash) : String
      ...
      private def chat_system_message(messages : Array(NamedTuple(role: String, content: String)), body : CogniCore::Workflow::AnyHash) : String?
