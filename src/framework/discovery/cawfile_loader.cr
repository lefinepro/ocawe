  ...
  module Discovery
    ...
    class CawfileLoader
      ...
      def self.load_all(dir : String) : Array(CawfileBundle)
        ...
        crystal.registry_files = discover_registry_files(crystal.requires, dir) + discover_command_plugins(dir)
      ...
      # Discovers local command plugins for the generated runtime entrypoint.
      # Canonical paths prevent duplicate requires and ensure symlinks cannot
      # pull source from outside the project being built.
      private def self.discover_command_plugins(project_dir : String) : Array(String)
