...
describe Cogni::Workflows::DSL::CrystalDSL do
  it "compiles and validates supported schema dsl expressions" do
    validator = Cogni::Workflows::DSL::CrystalDSL.compile(
    ...
    expect_raises(Cogni::Workflows::DSL::ValidationError) do
  ...
  it "rejects unsupported methods in schema dsl" do
    expect_raises(Cogni::Workflows::DSL::CrystalDSL::ParseError) do
      Cogni::Workflows::DSL::CrystalDSL.compile("Schema::Types.unknown()", "schema-invalid")
    end
  end
  ...
  it "rejects output schema that drops required input field" do
    ...
    expect_raises(Cogni::Workflows::DSL::ValidationError, /answer/) do
      Cogni::Workflows::DSL::Compatibility.ensure_output_superset!(input_schema, output_schema)
    end
  end
end
