...
#
# Configuration:
# - Model API: Configurable via COGNI_E2E_MODEL env var (default: openai/gpt-4.1-mini)
# - API keys: Stored in OPENAI_API_KEY secret
...
module E2ETestHelpers
  ...
  def default_model : String
    ENV["COGNI_E2E_MODEL"]? || "openai/gpt-4.1-mini"
  end
  ...
  def api_key_available? : Bool
    !ENV["OPENAI_API_KEY"]?.nil? && !ENV["OPENAI_API_KEY"]?.try(&.empty?)
  end
